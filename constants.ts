...
export const PROJECTS: Project[] = [
  {
    ...
    timeframe: "2024",
    summary:
      "Standardized IA and components, prototyped flows, and improved SEO clarity for a research program.",
    problem: "Inconsistent IA and low SEO clarity limited discoverability and task completion.",
    solution:
      "Rapid prototypes (Zilane), standardized components, and AI-assisted UX explorations.",
  ...
  },
  {
    ...
    timeframe: "2024–2025",
    summary:
      "Built UI system, routing, media pipeline, analytics, and E2E tests for an AI image-to-video product.",
    problem:
      "Need a performant, shippable front-end with preview interactions and stable media handling.",
    solution:
      "Design system, router-based navigation, Sharp media pipeline, analytics, and E2E coverage.",
    ...
    links: {
      live: "https://www.relive.photo/",
      repo: "https://github.com/joiscoding/relive",
      caseStudy: "#/case/relive",
    },
    images: [
  ...
  },
  {
    ...
    timeframe: "2024",
    summary:
      "Reservation and checkout flows with validation, tests, a11y, and an AI menu Q&A assistant.",
    problem: "Provide clear ordering/reservation UX with validation and accessibility.",
    solution:
      "React Router flows, Yup validation, Vitest + Testing Library + axe, ESLint/Prettier.",
    ...
    links: {
      live: "https://little-lemon-kappa.vercel.app/",
      repo: "https://github.com/heyitschien/little-lemon",
      caseStudy: "#/case/little-lemon",
    },
    images: [
...
export const TESTIMONIALS: Testimonial[] = [
  ...
  {
    quote: "Professional, responsive, and results-oriented. Exactly what our department needed.",
    author: "[Name]",
