  ...
  return (
    <Section id="about">
      ...
      <div className="grid items-start gap-12 md:grid-cols-5">
        ...
        <div className="rounded-2xl border-l-4 border-primary-light bg-gradient-to-br from-blue-50 via-purple-50 to-blue-50 p-6 shadow-lg transition-shadow hover:shadow-xl dark:border-primary-dark dark:from-blue-900/20 dark:via-purple-900/20 dark:to-blue-900/20">
