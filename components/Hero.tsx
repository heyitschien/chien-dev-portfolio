    ...
    <>
      ...
      >
        <div className="relative z-10 container mx-auto px-6">
          ...
          {/* Refined Headline */}
          <h1 className="mx-auto mb-4 max-w-4xl animate-fade-in-up text-4xl font-extrabold text-white [animation-delay:0.2s] sm:text-5xl md:text-6xl">
            Front-End Developer
            <br />
          ...
          {/* Refined Description */}
          <p className="mx-auto mb-2 max-w-3xl animate-fade-in-up text-lg text-white/90 [animation-delay:0.4s] sm:text-xl md:text-2xl">
            Building elegant interfaces with AI-accelerated workflows.
          </p>
          <p className="mx-auto mb-8 text-sm text-white/70 [animation-delay:0.4s] md:text-base">
          ...
          <div className="flex animate-fade-in-up flex-col items-center justify-center gap-4 [animation-delay:0.6s] sm:flex-row">
            ...
            <div className="flex gap-3">
              <a
                ...
                download={!!RESUME_URL}
                className={`inline-flex items-center gap-2 rounded-full border-2 border-white/30 bg-white/10 backdrop-blur-sm px-4 py-3 font-semibold text-white transition-all hover:scale-105 hover:bg-white/20 hover:shadow-lg ${!RESUME_URL ? "cursor-not-allowed opacity-60" : ""}`}
              ...
              <a
                ...
                className="rounded-full border-2 border-white/30 bg-white/10 backdrop-blur-sm px-4 py-3 font-semibold text-white transition-all hover:scale-105 hover:bg-white/20 hover:shadow-lg"
                style={{ filter: "url(#glass-effect)" }}
              >
                Book 15-min Call
              </a>
